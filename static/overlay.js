...
$(document).ready(function(){
    ...
    $('.show-popup-delete').click(function(event){
        event.preventDefault(); // disable normal link function so that it doesn't refresh the page
        var docHeight = $(document).height(); //grab the height of the page
        var scrollTop = $(window).scrollTop(); //grab the px value from the top of the page to where you're scrolling
        $('.overlay-box-delete').show().css({'height' : docHeight}); //display your popup and set height to the page height
    ...
    $('.close-btn').click(function(){
        $('.overlay-box-create').hide(); // hide the overlay
            $('.overlay-box-createType').hide(); // hide the overlay  
		$('.overlay-box-edit').hide(); // hide the overlay
                $('.overlay-box-delete').hide(); // hide the overlay
    });
    ...
    $('.overlay-box-create').click(function(){
      ...
      $('.overlay-box-createType').click(function(){
        $('.overlay-box-createType').hide(); // hide the overlay
    });
    $('.overlay-box-edit').click(function(){
        $('.overlay-box-edit').hide(); // hide the overlay
    });
     $('.overlay-box-delete').click(function(){
        $('.overlay-box-delete').hide(); // hide the overlay
    });
